...
|---|---|---|
| NEW-1 (idempotency stale-reclaim race, Medium) | Not touched — same mechanism reused unmodified | Implementation report §27 |
| NEW-2 (constraint naming, Low/cosmetic) | Not touched — lives in an already-applied migration | Implementation report §27 |
